...
class GameWindow(ui.ScriptWindow):
	...
	def __BuildKeyDict(self):
		...
		onPressKeyDict[app.DIK_F5] = lambda : self.OnPressF5Debug()
	...
	def OnPressEscapeKey(self):
		import chat
		chat.AppendChat(chat.CHAT_TYPE_INFO, "Il sistema legge le modifiche!")
	...
	def __ServerCommand_Build(self):
		serverCommandList={
			...
			# END_OF_WEDDING
			"DUNGEON_INFO_INDEX"	   : self.__DungeonInfoIndex,
	...
	def OnPressF5Debug(self):
		self.interface.ToggleDungeonInfoWindow()
		
	def __DungeonInfoIndex(self, value):
		import constInfo
		# Questo serve per mantenere aggiornato l'ID della quest in constInfo
		constInfo.DUNGEON_INDEX = int(value)